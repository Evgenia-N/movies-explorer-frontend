  ...
  return (
    <section className="about-project">
      ...
      <div className="about-project__details">
        ...
        <p className="about-project__description about-project__second-description">
